...
export default function ProjectCard({
	...
	if (featured) {
		return (
			...
			>
				<Card className="overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border-primary/20">
					<div className="flex flex-col md:flex-row">
						...
						<div className="md:w-3/5 flex flex-col justify-between p-6">
							<div>
								...
								<CardTitle className="text-2xl font-bold mb-3 group-hover:text-primary transition-colors duration-200">
									{name}
								</CardTitle>
